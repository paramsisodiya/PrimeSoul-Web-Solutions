          ...
          <div className="col-span-2">
            ...
            <div className="flex flex-col gap-3">
              <div className="flex flex-col gap-3 text-sm">
                <a href="mailto:primesoulwebsolutions@gmail.com" className="flex items-center gap-2 text-white/40 hover:text-brand-accent transition-colors">
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
                  primesoulwebsolutions@gmail.com
                </a>
              ...
              <div className="flex gap-3 mt-4">
                ...
                <a href="https://www.linkedin.com/company/primesoulwebsolutions/" target="_blank" rel="noopener noreferrer" className="p-2.5 rounded-full text-white/40 hover:text-white hover:bg-white/10 transition-all duration-300" style={{ border: '1px solid rgba(255,255,255,0.06)' }} aria-label="LinkedIn">
