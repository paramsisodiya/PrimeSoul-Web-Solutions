  ...
  return (
    <>
      ...
      {!isOpen && (
        <button
          onClick={handleOpen}
          className="fixed bottom-28 right-8 z-40 w-14 h-14 rounded-full flex items-center justify-center text-white shadow-2xl transition-all hover:scale-110 hover:-translate-y-1 animate-glow-pulse"
