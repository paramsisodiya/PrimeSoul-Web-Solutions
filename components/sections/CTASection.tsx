  ...
  return (
    <section className="py-20 sm:py-28 bg-white relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <AnimatedSection>
          <div
            className="relative rounded-2xl sm:rounded-3xl overflow-hidden p-8 sm:p-12 md:p-20 text-center noise-overlay"
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-white/50 text-base sm:text-lg mb-8 sm:mb-10 max-w-md mx-auto">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <MagneticButton strength={0.25} radius={150}>
                  <Link
                    href="/contact"
                    className="btn-tap group inline-flex items-center justify-center gap-2 px-6 sm:px-8 py-3.5 sm:py-4 rounded-full text-sm font-semibold transition-all duration-300 hover:-translate-y-px w-full sm:w-auto"
                    style={{
                ...
                <MagneticButton strength={0.2} radius={120}>
                  <a
                    ...
                    className="btn-tap inline-flex items-center justify-center gap-2 px-6 sm:px-8 py-3.5 sm:py-4 rounded-full text-sm font-semibold text-white border border-white/15 hover:bg-white/5 transition-all duration-200 w-full sm:w-auto"
                  >
