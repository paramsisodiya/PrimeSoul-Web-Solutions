...
export const metadata: Metadata = {
  ...
  description:
    'PrimeSoul builds premium websites and web applications for businesses that refuse to settle for average. Top web development agency in India.',
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en" suppressHydrationWarning>
      <body
        className={`${poppins.variable} ${dmSans.variable} ${playfair.variable} ${dmMono.variable} font-body antialiased`}
      >
        <JsonLd />
