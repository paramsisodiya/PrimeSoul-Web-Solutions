...
export const SERVICE_PAGES: ServicePageData[] = [
  ...
  },
  {
    ...
    faq: [
      { question: 'What\'s included in the maintenance plan?', answer: 'Monthly updates, security patches, uptime monitoring, daily backups, performance checks, and up to 2 hours of content/feature changes per month.' },
